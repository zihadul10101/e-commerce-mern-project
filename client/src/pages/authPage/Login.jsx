...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post('http://localhost:3002/api/auth/login', userData,
            {
            ...
            .then((response) => {
                ...
                const userId = response.data.payload.userWithoutPassword._id;
                toast.success('Login successful!'); // Success toast
                
                console.log("Data", response.data.payload.userWithoutPassword._id);
                            ...
                            <p class="text-sm mt-10">Don't have an account
                                <NavLink to='/register' >
                                    <a href="javascript:void(0);"
                                        class="text-blue-600 font-semibold hover:underline ml-1">Register here</a>
                                </NavLink>
                            </p>
                        </div>
                        <form onSubmit={handleSubmit} class="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
                            ...
                            <div>
                                <input
                                    ...
                                    required class="bg-gray-100 w-full text-sm px-4 py-3.5 rounded-md outline-blue-600"
