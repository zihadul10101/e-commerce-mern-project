    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
        <div className="p-4 flex bg-white rounded-md shadow-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 32 32">
        ...
        <div className="p-4 flex bg-white rounded-md shadow-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 682.667 682.667">
            <defs>
        ...
        <div className="p-4 flex bg-white rounded-md shadow-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 512.001 512.001">
        ...
        <div className="p-4 flex bg-white rounded-md shadow-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 24 24">
        ...
        <div className="p-4 flex bg-white rounded-md shadow-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-12 h-12 mr-6 bg-gray-100 p-3 rounded-md shrink-0" viewBox="0 0 504.69 504.69">
